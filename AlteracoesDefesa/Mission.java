...
public class Mission {
    ...
    public ArrayUnorderedList<Division> getDivisionsMoreThanOneItem(){

        ArrayUnorderedList<Division> tempDivisions = new ArrayUnorderedList<>();

        for (Division division : divisions) {
            if (division.getItems().size() > 1) {
                tempDivisions.addToRear(division);
            }
        }
